...
export function calculateBOM(inputs) {
  ...
  if (material === 'FRP') {
    ...
    const frpResult = calculateFRPTank(lengthPanels, widthPanels, height, perimeter, panelType, supportType, iBeamSize);
    return frpResult;
  }
...
function calculateBoltsAndNuts(lengthPanels, widthPanels, heightPanels, panelType, material) {
  ...
  // Generate SKU based on material
 ...
 * FRP Tank calculation
 */
function calculateFRPTank(lengthPanels, widthPanels, height, perimeter, panelType, supportType, iBeamSize) {

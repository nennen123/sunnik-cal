...
import { calculateFRPTank as calculateComprehensiveFRPTank } from './frpCalculator';
...
export function calculateBOM(inputs, prices = null) {
  ...
  if (material === 'FRP') {
    ...
    // Use comprehensive FRP calculator with 772 SKU support
    const frpResult = calculateComprehensiveFRPTank({
      length,
      width,
      height,
      partitionCount,
      buildStandard: inputs.buildStandard || 'MS1390',
 ...
 * FRP Tank calculation
 */
function calculateFRPTank(lengthPanels, widthPanels, height, perimeter, panelType, supportType, iBeamSize, panelTypeDetail = 'type1', prices = null) {
